...
Postgres has one application table: `rendition_jobs`. Effect SQL's `PgMigrator`
owns its schema migrations. No Space, Source, Asset, attempt-history, purge, or
delivery-token tables exist in v1.
