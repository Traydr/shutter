/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 5828d7cdf0d4a1e0dd669a51eb62051c)
// Runtime types generated with workerd@1.20260702.1 2026-07-10 
interface __BaseEnv_CloudflareBindings {
	DERIVATIVE_STORE: R2Bucket;
	EDGE_CONFIG_TOKEN: string;
