/**
 * RFC 9457 problem responses for the v2 JSON endpoints. `code` is the member
...
export function problemDetails(code: ProblemCode, requestId?: string): ProblemDetails {
...
export function problemResponse(code: ProblemCode, requestId?: string): Response {
  const details = problemDetails(code, requestId);
